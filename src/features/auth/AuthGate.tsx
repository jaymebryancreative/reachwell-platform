...
export function AuthGate({ children }: { children: ReactNode }) {
  ...
  const submit = async (event: FormEvent) => {
    ...
    if (!isSupabaseConfigured) {
      setError('ReachWell authentication is not configured for this deployment. Configure VITE_SUPABASE_URL and VITE_SUPABASE_PUBLISHABLE_KEY in the Vercel project environment, then redeploy.')
      setBusy(false)
      return
    }
