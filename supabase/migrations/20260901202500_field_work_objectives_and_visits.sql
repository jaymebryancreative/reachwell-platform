...
create index if not exists assignment_objectives_assignment_idx on public.assignment_objectives (assignment_id, sort_order);
create index if not exists assignment_objectives_org_status_idx on public.assignment_objectives (organization_id, status);
create index if not exists assignment_visits_assignment_idx on public.assignment_visits (assignment_id, started_at desc);
