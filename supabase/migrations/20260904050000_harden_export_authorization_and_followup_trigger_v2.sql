-- Align export-history RLS with the server-side leadership boundary and avoid OLD access on INSERT triggers.
...
begin
  ...
  select jsonb_build_object(
    'exported_at',now(),'organization_id',p_organization_id,
